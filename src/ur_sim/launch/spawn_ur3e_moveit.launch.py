...
def generate_launch_description():
    ...
    joint_controllers_file = os.path.join(
        get_package_share_directory('ur_sim'), 'config', 'ur3e_controllers.yaml'
    )
    ...
    moveit_config = (
        MoveItConfigsBuilder("custom_robot", package_name="ur_moveit")
    ...
    rviz_config_path = os.path.join(
        get_package_share_directory("ur_moveit"),
        "config",
        "moveit.rviz",
    )
